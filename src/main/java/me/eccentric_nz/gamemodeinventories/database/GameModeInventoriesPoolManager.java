 ...
 */
public class GameModeInventoriesPoolManager {
     ...
     */
    public GameModeInventoriesPoolManager(ConnectionPoolDataSource dataSource, int maxConnections) {
     ...
     */
    public GameModeInventoriesPoolManager(ConnectionPoolDataSource dataSource, int maxConnections, int timeout) {
...
} // end class GameModeInventoriesPoolManager
