...
public class GameModeInventoriesSQLite {
    ...
    public void createTables() {
        ...
        try {
            ...
            // add worlds table
            String queryWorlds = "CREATE TABLE IF NOT EXISTS " + plugin.getPrefix() + "worlds (id INTEGER PRIMARY KEY NOT NULL, uuid TEXT, world TEXT, x REAL, y REAL, z REAL, yaw REAL, pitch REAL)";
