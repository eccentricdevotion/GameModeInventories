...
public class GMINbtFactory {
    ...
    // Shared instance
    private static GMINbtFactory INSTANCE;
     ...
     * @return The factory.
     */
    private static GMINbtFactory get() {
        if (INSTANCE == null) {
            INSTANCE = new GMINbtFactory();
        }
        return INSTANCE;
    }
    ...
    private GMINbtFactory() {
        if (BASE_CLASS == null) {
            try {
                ...
                ClassLoader loader = GMINbtFactory.class.getClassLoader();
